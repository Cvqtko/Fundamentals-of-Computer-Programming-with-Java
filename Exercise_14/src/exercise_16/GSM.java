...
/* 16. ¬ класа GSM добавете метод, който пресм€та общата сума на обажда-ни€та (Call) 
от архива с обаждани€ на телефона (callHistory) като нека цената за едно обаждане се подава като параметър на метода.*/
